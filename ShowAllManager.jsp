...
response.setHeader("Cache-control","no-cache, no-store, must-revalidate");
  ...
  elist = TutionWorker.showAllManager();
...
<body>
 ...
 <table class="table table-hover">
	   ...
	   <tbody>
		...
		%>
	   <tr>
	      <td><a href="managerById.jsp?id=<%= t.getManagerId()%>"><%= t.getManagerId()%></a></td>
		  <td><%= t.getManagerName()%></td>
		  <td><%= t.getManagerUserId()%></td>
	   </tr>
	   <% 
	      }
	   %>
