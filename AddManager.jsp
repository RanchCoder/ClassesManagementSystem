...
<body>
  ...
  <div class="col-sm-6">
             ...
             <h1>ADD Manager</h1> <br /><br /><br /><br />


		 <form  method="post" action="managerAdd.jsp">
		 <div class="form-group">
		   ...
		   <div class="form-group">
			...
			<input type="text" name="name" pattern="[A-Za-z]{25}" onkeyup="lettersOnly(this)" requred title="must contain only characters" id="name" class="form-control">
            </div>
