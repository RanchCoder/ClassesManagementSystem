...
response.setHeader("Cache-control","no-cache, no-store, must-revalidate");
  ...
  elist = TutionWorker.showAllAdmin();
...
<body>
 ...
 <table class="table table-hover">
       ...
       <tr>
		...
		<tbody>
	   <tr>
	      <td><a href="adminById.jsp?id=<%= t.getAdminId()%>"><%= t.getAdminId()%></a></td>
		  <td><%= t.getAdminName()%></td>
		  <td><%= t.getAdminUserId()%></td>
	   </tr>
	   </tbody>
	   <% 
	      }
