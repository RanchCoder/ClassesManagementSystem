...
response.setHeader("Cache-control","no-cache, no-store, must-revalidate");
  ...
  elist = TutionWorker.showAllFees();
...
<body>
 ...
 <table class="table table-hover">
       ...
       <tr>
		...
		%>
	   <tr>
	      <td><a href="feesById.jsp?id=<%= t.getFeesId()%>"><%= t.getFeesId()%></a></td>
		  <td><%= t.getFeesAmount()%></td>
		  <td><%= t.getFeesAmountPending()%></td>
		  		  <td><%= t.getFeesAmountPaid()%></td>
	   </tr>
	   <% 
	      }
	   %>
