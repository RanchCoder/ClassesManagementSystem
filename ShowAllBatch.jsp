...
response.setHeader("Cache-control","no-cache, no-store, must-revalidate");
  ...
  elist = TutionWorker.showAllBatch();
...
<h1>Show All Batch</h1>
 ...
 <table class="table table-hover">
	   ...
	   <tbody>
		...
		%>
	   <tr>
	      <td><a href="batchById.jsp?id=<%= t.getBatchId()%>"><%= t.getBatchId()%></a></td>
		  <td><%= t.getBatchName()%></td>
		  <td><%= t.getBatchTiming()%></td>
          <td><%= t.getBatchSubject()%></td>
	   </tr>
	   <% 
	      }
	   %>
