 <%@page import="com.ProjectClassFiles.*,java.util.*"%>
...
<html>
 ...
 <link rel="stylesheet" href="../bootstrap-3.3.7/dist/css/bootstrap.min.css">
  ...
  <script src="../bootstrap-3.3.7/dist/js/bootstrap.min.jsf"></script>
 ...
 <body>
  ...
  <div class="col-sm-6">
             ...
             <h1>ADD Teacher</h1> <br /><br /><br /><br />


		 <form  method="post" action="teacherAdd.jsp">
		 <div class="form-group">
		   ...
		   <div class="form-group">
			...
			<input type="text" name="name" pattern="[A-Za-z]{25}" onkeyup="lettersOnly(this)" title="must contain only characters" id="name" class="form-control" required>
            </div>
