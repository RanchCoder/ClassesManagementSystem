 ...
 <body>
	    ...
	    <div class="row">
		  ...
		  <div class="col-sm-6">
             ...
             <h1>ADD Student</h1> <br /><br /><br /><br />


		 <form  method="post" action="addStudent.jsp">
		 <div class="form-group">
		   <label for="id">Enter Student Id</label>
		   <input type="number" required name="id" id="id" class="form-control" required> 
		   </div>
		   ...
		   <div class="form-group">
			...
			<input type="text" name="name" pattern="[A-Za-z]{,25}" onkeyup="lettersOnly(this)" title="must contain only characters" required id="name" class="form-control" required>
            </div>

			 <div class="form-group">

		 	<label  for="id">Select Batch ID</label>
		         <div class="form-group">
