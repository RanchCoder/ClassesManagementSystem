...
<body>
  ...
  <div class="col-sm-6">
             ...
             <h1>ADD Batch</h1> <br /><br /><br /><br />




		 <form method="post" action="batchAdd.jsp">

		 <div class="form-group">
		   <label for="id">Enter Batch Id</label>
			...
			<input type="text" name="name" id="name" pattern="[A-Za-z]{,25}" onkeyup="lettersOnly(this)" title="must contain only characters" class="form-control" required><br />
             </div>
             
			 <div class="form-group">
			<label for="time">Batch Time</label>
			<input type="text" name="time" id="time" pattern="[A-Za-z]{25}" title="must contain only characters" class="form-control" required><br />
             </div>

             <div class="form-group">
			<label for="subject">Subject</label>
			<input type="text" name="subject" id="subject" pattern="[A-Za-z]{25}" title="must contain only characters" class="form-control" required><br />
			</div>
