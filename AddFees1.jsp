 ...
 if(session.getAttribute("username")==null){
       ...
       response.sendRedirect("login.html");
		 ...
		 elist = TutionWorker.selectIdOfStudent();
%>

<html>
  <head><title>ADD Fees details</title>
 ...
 <body>
	    ...
	    <div class="row">
		  ...
		  <div class="col-sm-6">
             ...
             <h1>ADD FEES</h1> <br /><br />

         
		 <form method="post" action="feesAdd.jsp">
		 ...
		 <%
			 for(Tution t : elist){
		 %>
							<option value="<%= t.getStudentId()%>"><%= t.getStudentId()%></option>
	 ...
	 %>
		    ...
		    <input type="number" name="amount" id="amount" class="form-control" required>
		     ...
		     <div class="form-group">
		     <label for="Pamount">Enter Paid Amount</label>
             <input type="number" name="paid" id="Pamount" class="form-control" required>
             </div>
             
			 <div class="form-group">
			 <label for="pending">Enter Pending Amount</label>
