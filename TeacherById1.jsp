...
response.setHeader("Cache-control","no-cache, no-store, must-revalidate");
  ...
  elist = TutionWorker.selectIdOfTeacher();
...
<!doctype html>
<html>
  <head><title>Teacher BY ID</title>
...
<body>
	 ...
	 <h2>WELCOME...</h2>		 
        ...
        <div class="container">
		 ...
		 <form method="post" action="teacherById.jsp">
		 	...
		 	<label  for="id">Select ID</label>
		         <div class="form-group">
				  ...
				  <%
				    for(Tution t : elist){
				  %>
                   <option value="<%= t.getTeacherId()%>"><%= t.getTeacherId()%></option>
